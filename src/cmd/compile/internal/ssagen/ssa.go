...
func InitTables() {
	...
	brev_arch := []sys.ArchFamily{sys.AMD64, sys.I386, sys.ARM64, sys.ARM, sys.S390X, sys.Thumb}
	...
	addF("math", "Abs",
		...
		sys.ARM64, sys.ARM, sys.PPC64, sys.RISCV64, sys.Wasm, sys.MIPS, sys.MIPS64, sys.Thumb)
	addF("math", "Copysign",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("math/bits", "TrailingZeros64",
		...
		sys.AMD64, sys.I386, sys.ARM64, sys.ARM, sys.S390X, sys.MIPS, sys.PPC64, sys.Wasm, sys.Thumb)
	...
	addF("math/bits", "TrailingZeros8",
		...
		sys.AMD64, sys.I386, sys.ARM, sys.ARM64, sys.Wasm, sys.Thumb)
	addF("math/bits", "TrailingZeros8",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("math/bits", "RotateLeft32",
		...
		sys.AMD64, sys.ARM, sys.ARM64, sys.S390X, sys.PPC64, sys.Thumb, sys.Wasm, sys.Loong64)
...
func (s *State) Call(v *ssa.Value) *obj.Prog {
	...
	if sym, ok := v.Aux.(*ssa.AuxCall); ok && sym.Fn != nil {
		...
		case sys.ARM, sys.ARM64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.Thumb:
			p.To.Type = obj.TYPE_MEM
		default:
