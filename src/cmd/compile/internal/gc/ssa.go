...
func init() {
	...
	addF("math", "Sqrt",
		...
		sys.I386, sys.AMD64, sys.ARM, sys.Thumb, sys.ARM64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X, sys.Wasm)
	addF("math", "Trunc",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
	...
	addF("math", "Abs",
		...
		sys.ARM64, sys.ARM, sys.Thumb, sys.PPC64, sys.Wasm)
	addF("math", "Copysign",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
	...
	addF("math/bits", "TrailingZeros16",
		...
		sys.AMD64, sys.I386, sys.ARM, sys.Thumb, sys.ARM64, sys.Wasm)
	addF("math/bits", "TrailingZeros16",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
	...
	addF("math/bits", "RotateLeft32",
		...
		sys.AMD64, sys.ARM, sys.Thumb, sys.ARM64, sys.S390X, sys.PPC64, sys.Wasm)
