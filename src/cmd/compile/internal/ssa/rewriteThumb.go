// Code generated from _gen/Thumb.rules using 'go generate'; DO NOT EDIT.
...
func rewriteValueThumb(v *Value) bool {
	...
	case OpBitLen16:
		return rewriteValueThumb_OpBitLen16(v)
	case OpBitLen32:
		return rewriteValueThumb_OpBitLen32(v)
	case OpBitLen8:
		return rewriteValueThumb_OpBitLen8(v)
	case OpBswap32:
		v.Op = OpThumbREV
		return true
	case OpClosureCall:
	...
	case OpOrB:
		...
		return true
	case OpPanicBounds:
		v.Op = OpThumbLoweredPanicBoundsRR
		return true
	case OpPanicExtend:
		v.Op = OpThumbLoweredPanicExtendRR
		return true
	case OpPubBarrier:
		v.Op = OpThumbDMB_ST
		return true
	...
	case OpThumbLoweredPanicBoundsRC:
		return rewriteValueThumb_OpThumbLoweredPanicBoundsRC(v)
	case OpThumbLoweredPanicBoundsRR:
		return rewriteValueThumb_OpThumbLoweredPanicBoundsRR(v)
	case OpThumbLoweredPanicExtendRC:
		return rewriteValueThumb_OpThumbLoweredPanicExtendRC(v)
	case OpThumbLoweredPanicExtendRR:
		return rewriteValueThumb_OpThumbLoweredPanicExtendRR(v)
	...
	case OpThumbMOVWnop:
		return rewriteValueThumb_OpThumbMOVWnop(v)
	case OpThumbMOVWreg:
	...
	case OpThumbSRR:
		return rewriteValueThumb_OpThumbSRR(v)
	case OpThumbSUB:
...
func rewriteValueThumb_OpBitLen16(v *Value) bool {
	v_0 := v.Args[0]
	b := v.Block
...
func rewriteValueThumb_OpBitLen8(v *Value) bool {
	v_0 := v.Args[0]
	b := v.Block
	typ := &b.Func.Config.Types
	// match: (BitLen8 x)
...
func rewriteValueThumb_OpThumbANDshiftLL(v *Value) bool {
	...
	for {
		c := auxIntToInt32(v.AuxInt)
		y := v_0
		if y.Op != OpThumbSLLconst || auxIntToInt32(y.AuxInt) != c {
			break
		}
		x := y.Args[0]
		if x != v_1 {
...
func rewriteValueThumb_OpThumbANDshiftRA(v *Value) bool {
	...
	for {
		c := auxIntToInt32(v.AuxInt)
		y := v_0
		if y.Op != OpThumbSRAconst || auxIntToInt32(y.AuxInt) != c {
			break
		}
		x := y.Args[0]
		if x != v_1 {
...
func rewriteValueThumb_OpThumbANDshiftRL(v *Value) bool {
	...
	for {
		c := auxIntToInt32(v.AuxInt)
		y := v_0
		if y.Op != OpThumbSRLconst || auxIntToInt32(y.AuxInt) != c {
			break
		}
		x := y.Args[0]
		if x != v_1 {
...
func rewriteValueThumb_OpThumbBICshiftLL(v *Value) bool {
	...
	for {
		c := auxIntToInt32(v.AuxInt)
		if v_0.Op != OpThumbSLLconst || auxIntToInt32(v_0.AuxInt) != c {
			break
		}
		x := v_0.Args[0]
		if x != v_1 {
...
func rewriteValueThumb_OpThumbBICshiftRA(v *Value) bool {
	...
	for {
		c := auxIntToInt32(v.AuxInt)
		if v_0.Op != OpThumbSRAconst || auxIntToInt32(v_0.AuxInt) != c {
			break
		}
		x := v_0.Args[0]
		if x != v_1 {
...
func rewriteValueThumb_OpThumbBICshiftRL(v *Value) bool {
	...
	for {
		c := auxIntToInt32(v.AuxInt)
		if v_0.Op != OpThumbSRLconst || auxIntToInt32(v_0.AuxInt) != c {
			break
		}
		x := v_0.Args[0]
		if x != v_1 {
...
func rewriteValueThumb_OpThumbLoweredPanicBoundsRC(v *Value) bool {
	v_1 := v.Args[1]
	v_0 := v.Args[0]
	...
	for {
		...
		c := auxIntToInt32(v_0.AuxInt)
		mem := v_1
		v.reset(OpThumbLoweredPanicBoundsCC)
...
func rewriteValueThumb_OpThumbLoweredPanicBoundsRR(v *Value) bool {
	v_2 := v.Args[2]
	v_1 := v.Args[1]
	v_0 := v.Args[0]
	...
	for {
		...
		c := auxIntToInt32(v_1.AuxInt)
		mem := v_2
		v.reset(OpThumbLoweredPanicBoundsRC)
		v.AuxInt = int64ToAuxInt(kind)
	...
	for {
		...
		y := v_1
		mem := v_2
		v.reset(OpThumbLoweredPanicBoundsCR)
		v.AuxInt = int64ToAuxInt(kind)
		v.Aux = panicBoundsCToAux(PanicBoundsC{C: int64(c)})
		v.AddArg2(y, mem)
		return true
...
func rewriteValueThumb_OpThumbLoweredPanicExtendRC(v *Value) bool {
	v_2 := v.Args[2]
	v_1 := v.Args[1]
	v_0 := v.Args[0]
...
func rewriteValueThumb_OpThumbLoweredPanicExtendRR(v *Value) bool {
	v_3 := v.Args[3]
	v_2 := v.Args[2]
	v_1 := v.Args[1]
	v_0 := v.Args[0]
	...
	for {
		...
		hi := v_0
		lo := v_1
		if v_2.Op != OpThumbMOVWconst {
			break
		}
		c := auxIntToInt32(v_2.AuxInt)
		mem := v_3
		v.reset(OpThumbLoweredPanicExtendRC)
		v.AuxInt = int64ToAuxInt(kind)
		v.Aux = panicBoundsCToAux(PanicBoundsC{C: int64(c)})
		v.AddArg3(hi, lo, mem)
		return true
...
func rewriteValueThumb_OpThumbMOVWnop(v *Value) bool {
	v_0 := v.Args[0]
...
func rewriteValueThumb_OpThumbSRR(v *Value) bool {
	v_1 := v.Args[1]
	v_0 := v.Args[0]
