...
func init() {
	...
	ops := []opData{
		...
		{name: "SLLconst", argLength: 1, reg: gp11, asm: "SLL", aux: "Int32", clobberFlags: true}, // arg0 << auxInt, 0 <= auxInt < 32
		{name: "SRL", argLength: 2, reg: gp21, asm: "SRL", clobberFlags: true},                    // arg0 >> arg1, unsigned, shift amount is mod 256
		{name: "SRLconst", argLength: 1, reg: gp11, asm: "SRL", aux: "Int32", clobberFlags: true}, // arg0 >> auxInt, unsigned, 0 <= auxInt < 32
		{name: "SRA", argLength: 2, reg: gp21, asm: "SRA", clobberFlags: true},                    // arg0 >> arg1, signed, shift amount is mod 256
		{name: "SRAconst", argLength: 1, reg: gp11, asm: "SRA", aux: "Int32", clobberFlags: true}, // arg0 >> auxInt, signed, 0 <= auxInt < 32
		{name: "SRR", argLength: 2, reg: gp21, asm: "SRR", clobberFlags: true},                    // arg0 right rotate by arg1 bits
		{name: "SRRconst", argLength: 1, reg: gp11, asm: "SRR", aux: "Int32", clobberFlags: true}, // arg0 right rotate by auxInt bits, 0 <= auxInt < 32
		...
		// moves
		{name: "MOVWconst", argLength: 0, reg: gp01, aux: "Int32", asm: "MOVW", typ: "UInt32", rematerializeable: true}, // MOVW.P, 32 low bits of auxint
