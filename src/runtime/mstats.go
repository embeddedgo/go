...
type mstats struct {
	...
	pause_ns        [256*(1-_MCU) + 16*memScale*_MCU]uint64 // circular buffer of recent gc pause lengths
	pause_end       [256*(1-_MCU) + 16*memScale*_MCU]uint64 // circular buffer of recent gc end times (nanoseconds since 1970)
	numgc           uint32
...
type MemStats struct {
	...
	PauseNs [256*(1-_MCU) + 16*memScale*_MCU]uint64
	...
	PauseEnd [256*(1-_MCU) + 16*memScale*_MCU]uint64
