...
const (
	gcSweepBlockEntries    = 512*_OS + noosGCSweepBlockEntries    // 4KB on 64-bit
	gcSweepBufInitSpineCap = 256*_OS + noosGCSweepBufInitSpineCap // Enough for 1GB heap on 64-bit
)
