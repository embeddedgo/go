...
nothingToCopy:
	...
	// disable interrupts
	CSRRCI  (8, MSTATUS, a3)  // A3=MSTATUS
...
TEXT runtime·saveRegs(SB),NOSPLIT|NOFRAME,$0
	...
	MOV  TMP, (26*8)(A0)
#define numGPRS 27
	MOVD  F0, ((0+numGPRS)*8)(A0)
	MOVD  F1, ((1+numGPRS)*8)(A0)
	MOVD  F2, ((2+numGPRS)*8)(A0)
	MOVD  F3, ((3+numGPRS)*8)(A0)
	MOVD  F4, ((4+numGPRS)*8)(A0)
	MOVD  F5, ((5+numGPRS)*8)(A0)
	MOVD  F6, ((6+numGPRS)*8)(A0)
	MOVD  F7, ((7+numGPRS)*8)(A0)
	MOVD  F8, ((8+numGPRS)*8)(A0)
	MOVD  F9, ((9+numGPRS)*8)(A0)
	MOVD  F10, ((10+numGPRS)*8)(A0)
	MOVD  F11, ((11+numGPRS)*8)(A0)
	MOVD  F12, ((12+numGPRS)*8)(A0)
	MOVD  F13, ((13+numGPRS)*8)(A0)
	MOVD  F14, ((14+numGPRS)*8)(A0)
	MOVD  F15, ((15+numGPRS)*8)(A0)
	MOVD  F16, ((16+numGPRS)*8)(A0)
	MOVD  F17, ((17+numGPRS)*8)(A0)
	MOVD  F18, ((18+numGPRS)*8)(A0)
	MOVD  F19, ((19+numGPRS)*8)(A0)
	MOVD  F20, ((20+numGPRS)*8)(A0)
	MOVD  F21, ((21+numGPRS)*8)(A0)
	MOVD  F22, ((22+numGPRS)*8)(A0)
	MOVD  F23, ((23+numGPRS)*8)(A0)
	MOVD  F24, ((24+numGPRS)*8)(A0)
	MOVD  F25, ((25+numGPRS)*8)(A0)
	MOVD  F26, ((26+numGPRS)*8)(A0)
	MOVD  F27, ((27+numGPRS)*8)(A0)
	MOVD  F28, ((28+numGPRS)*8)(A0)
	MOVD  F29, ((29+numGPRS)*8)(A0)
	MOVD  F30, ((30+numGPRS)*8)(A0)
	MOVD  F31, ((31+numGPRS)*8)(A0)
	CSRR  (FCSR, a1)
	MOV   A1, ((32+numGPRS)*8)(A0)
