...
const (
	...
	_StackMin = 2048*(1-_MCU) + 512*_MCU*(1+_64bit) // actual round2(_StackMin+_StackSystem) - _StackSystem
	...
	// bottom of the stack.
	_StackGuard = 896*sys.StackGuardMultiplier*(1-_ARMv7M) + 448*_ARMv7M + _StackSystem
