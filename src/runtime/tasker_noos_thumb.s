...
TEXT ·faultHandler(SB),NOSPLIT|NOFRAME,$0-0
	...
	//                    ABFSR: x/xw 0xE000EFA8 (Cortex-M7)
...
TEXT ·reservedHandler(SB),NOSPLIT|NOFRAME,$0-0
	B   ·faultHandler(SB)

TEXT ·nmiHandler(SB),NOSPLIT|NOFRAME,$0-0
	B   ·faultHandler(SB)

TEXT ·hardfaultHandler(SB),NOSPLIT|NOFRAME,$0-0
	B   ·faultHandler(SB)

TEXT ·memmanageHandler(SB),NOSPLIT|NOFRAME,$0-0
	B   ·faultHandler(SB)

TEXT ·busfaultHandler(SB),NOSPLIT|NOFRAME,$0-0
	B   ·faultHandler(SB)

TEXT ·usagefaultHandler(SB),NOSPLIT|NOFRAME,$0-0
	B   ·faultHandler(SB)

TEXT ·securefaultHandler(SB),NOSPLIT|NOFRAME,$0-0
	B   ·faultHandler(SB)

TEXT ·debugmonHandler(SB),NOSPLIT|NOFRAME,$0-0
	B   ·faultHandler(SB)
...
TEXT ·svcallHandler(SB),NOSPLIT|NOFRAME,$0-0
...
TEXT ·unhandledException(SB),NOSPLIT|NOFRAME,$0-0
	BKPT
	B   -1(PC)
